...
interface SimplifiedPDFEditorProps {
...
const SimplifiedPDFEditor: React.FC<SimplifiedPDFEditorProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[95vh] m-4 flex flex-col">
        {/* Header */}
...
export default SimplifiedPDFEditor;
