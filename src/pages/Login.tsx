...
const Login = () => {
  ...
  // Check and clear expired token on component mount
  React.useEffect(() => {
    const checkToken = async () => {
      ...
      if (token && isTokenExpired(token)) {
        ...
        console.log('[AUTH] 🧹 Cleared expired token on login page', {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Re-initialize socket connection with new token
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-11 bg-background border-2 focus:border-primary pr-10"
                  />
                  <button
                    type="button"
