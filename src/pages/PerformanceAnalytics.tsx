      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Individual and class performance monitoring with graphical representation
          </p>
        </div>
        ...
        <Card className="bg-gradient-to-br from-primary/10 to-primary/20 border-primary/30">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">
              {mockPerformanceData.classPerformance.find(cls => cls.class === selectedClass)?.averagePercentage || 0}%
            </div>
        ...
        <Card className="bg-gradient-to-br from-success/10 to-success/20 border-success/30">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-success">
              {mockPerformanceData.individual.reduce((prev, current) => 
                prev.overallPercentage > current.overallPercentage ? prev : current
              ).overallPercentage}%
            </div>
            <p className="text-xs text-muted-foreground">Highest individual score</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-warning/10 to-warning/20 border-warning/30">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-warning">
              {mockPerformanceData.classPerformance.find(cls => cls.class === selectedClass)?.totalStudents || 0}
            </div>
        ...
        <Card className="bg-gradient-to-br from-accent/10 to-accent/20 border-accent/30">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-accent">
              {mockPerformanceData.classPerformance.find(cls => cls.class === selectedClass)?.gradeDistribution['A+'] || 0}
            </div>
